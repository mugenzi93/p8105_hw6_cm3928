...
Let's now produce estimates for each bootstrap sample, compute their `log` result, then plot their distribution:
...
The `log(beta_0*beta_1)` looks normally distributed with a dent at the maximum point (turning point).
